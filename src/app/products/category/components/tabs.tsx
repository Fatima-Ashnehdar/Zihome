          ...
          <div className="flex items-center gap-x-2">
            ...
            <TabsList variant="line" className="flex gap-x-8">
              <TabsTrigger value="decoration">
                <p className="text-base font-normal text-gray-900"> دکوراسیون</p>
              </TabsTrigger>
              <TabsTrigger value="latest">
                <p className="text-base font-normal text-gray-900"> جدیدترین</p>
              </TabsTrigger>
              <TabsTrigger value="best-selling">
                <p className="text-base font-normal text-gray-900"> پرفروش ترین</p>
              </TabsTrigger>
              <TabsTrigger value="buyers-recommendations">
                <p className="text-base font-normal text-gray-900"> پیشنهاد خریداران</p>
              </TabsTrigger>
            </TabsList>
          </div>
