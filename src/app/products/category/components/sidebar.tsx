      ...
      <Accordion className="w-full flex flex-col gap-y-2">
        <AccordionItem value="item-1" className="pb-2">
          ...
          <AccordionContent>
            ...
            <div className="flex justify-end gap-x-2">
              <p className="text-sm text-gray7">دوقلو</p>
              <Checkbox
                id="filter-twins-checkbox"
                name="finder-pref-9k2-external-disks-1yg-checkbox"
              />
            </div>
            <div className="flex justify-end gap-x-2">
              <p className="text-sm text-gray7">چهار درب</p>
              <Checkbox
                id="filter-fourDoor-checkbox"
                name="finder-pref-9k2-external-disks-1yg-checkbox"
              />
            </div>
          </AccordionContent>
...
stify-between items-center bg-gray5 border border-gray4 rounded-lg px-4"
                >
        ...
        <AccordionItem value="item-3" className="-mb-1">
          ...
          <AccordionContent>
            <div className="flex justify-end gap-x-2 pt-4">
              <p className="text-sm text-gray7">بوش</p>
              <Checkbox
                id="filter-brand-bosch-checkbox"
                name="finder-pref-9k2-external-disks-1yg-checkbox"
              />
            </div>
            <div className="flex justify-end gap-x-2">
              <p className="text-sm text-gray7">سامسونگ</p>
              <Checkbox
                id="filter-brand-samsung-checkbox"
                name="finder-pref-9k2-external-disks-1yg-checkbox"
              />
            </div>
            <div className="flex justify-end gap-x-2">
              <p className="text-sm text-gray7">ال جی</p>
              <Checkbox
                id="filter-brand-LG-checkbox"
                name="finder-pref-9k2-external-disks-1yg-checkbox"
              />
            </div>
            <div className="flex justify-end gap-x-2">
              <p className="text-sm text-gray7">اسنوا</p>
              <Checkbox
                id="filter-brand-snowa-checkbox"
                name="finder-pref-9k2-external-disks-1yg-checkbox"
              />
            </div>
            <div className="flex justify-end gap-x-2">
              <p className="text-sm text-gray7">امرسان</p>
              <Checkbox
                id="filter-brand-emersun-checkbox"
                name="finder-pref-9k2-external-disks-1yg-checkbox"
              />
            </div>
          </AccordionContent>
