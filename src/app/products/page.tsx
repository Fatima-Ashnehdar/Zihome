...
import photo4 from "@/../public/pictures/products/pic (40).png";
import photo5 from "@/../public/pictures/products/pic (41).png";
import photo6 from "@/../public/pictures/products/pic (42).png";
...
export default function ProductsPage() {
  const products = [
    {
      ...
      score: "۴.۳",
      photo: photo1,
      currentPrice: "۳,۷۸۰,۰۰۰",
      previousPrice: "۵,۴۰۰,۰۰۰",
      model: "N-llTE ۲۰۳ alRllNKS",
      discount: "۳۰٪",
    },
    {
      id: "2",
      name: "سرویس قابلمه تفلون",
      score: "۴.۳",
      photo: photo2,
      currentPrice: "۱,۶۴۰,۰۰۰",
      previousPrice: "۲,۴۰۰,۰۰۰",
      model: "N-llTE ۲۰۳ alRllNKS",
      discount: "۳۰٪",
    },
    {
      ...
      score: "۴.۳",
      photo: photo3,
      currentPrice: "۶,۰۴۸,۰۰",
      previousPrice: "۸,۶۴۰,۰۰۰",
      model: "N-llTE ۲۰۳ alRllNKS",
      discount: "۳۰٪",
    },
    {
      id: "4",
      name: "یخچال فریزر ساید بای ساید ال جی",
      score: "۴.۳",
      photo: photo4,
      currentPrice: "۱,۶۴۰,۰۰۰",
      previousPrice: "۲,۴۰۰,۰۰۰",
    ...
    {
      id: "5",
      name: "ماکروویو کنوود ۲۴۰ لیتری",
      score: "۴.۳",
      photo: photo5,
      currentPrice: "۳,۶۴۰,۰۰۰",
      previousPrice: "۴,۴۰۰,۰۰۰",
      model: "N-llTE ۲۰۳ alRllNKS",
      discount: "۳۰٪",
    },
    {
      id: "6",
      name: "ست ماهیتابه تفلون",
      score: "۴.۳",
      photo: photo6,
      currentPrice: "۱,۶۴۰,۰۰۰",
      previousPrice: "۲,۴۰۰,۰۰۰",
    ...
    {
      id: "8",
      name: "یخچال فریزر دوقلو دیپوینت",
      score: "۴.۳",
      photo: photo8,
      currentPrice: "۱,۶۴۰,۰۰۰",
      previousPrice: "۲,۴۰۰,۰۰۰",
  ...
  return (
    <div className="px-30  py-8 flex flex-col gap-y-12 bg-gray10">
